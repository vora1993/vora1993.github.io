    ...
    setInterval(() => {
        if (widthScreen < 800) {
            if (logoNum === 0) {
                ...
                document.getElementById('benefits-img').style.height = '15rem';
                document.getElementById('benefits-img').style.width = '15rem';
                ...
                document.getElementById('benefits-img').style.height = '18rem';
                document.getElementById('benefits-img').style.width = '18rem';
                ...
                document.getElementById('benefits-img').style.height = '20rem';
                document.getElementById('benefits-img').style.width = '20rem';
...
benefitsSlide.addEventListener('touchend', (e) => {
    if (xCordStartBenefit - xCordEndBenefit > 100 && xCordStartBenefit - xCordEndBenefit < 300) {
        if (widthScreen < 800) {
            if (logoNum === 0) {
                document.getElementById('benefits-img').src = logo[1];
                document.getElementById('benefits-heading').textContent = logoHeading[1];
